...
Este proyecto se debe "resolver" en pares. Recuerda que deberas de consumir una
...
como [nock](https://github.com/nock/nock), [json-server](https://www.npmjs.com/package/json-server), [mock service worker](https://mswjs.io/docs/)
